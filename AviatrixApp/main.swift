...
//this asks where to fly to
func fly(myPlane : Aviatrix) {
    print("Where would you like to fly to? ")
    print(" ")
    
    //calling the aviatrix class and using the knownDestinations func 
...
func refuel(myPlane : Aviatrix) {
    ...
    print("Refueling...")
    print("⛽ Here in \(myPlane.currentLocation), jet fuel costs _________)")
